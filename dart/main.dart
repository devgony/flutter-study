...
class Dictionary {
  ...
  void add(Map<Term, Definition> map) {
    words.addAll(map);
  }
...
main() {
  ...
  Definition? updated = dictionary.upsert('Dart', 'flutting language');
  assert(updated == 'flutting language');
